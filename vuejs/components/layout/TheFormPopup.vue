...
const quantityProperty = ref(1);
const buyDateProperty = ref(new Date().toISOString().substr(0, 10));
const nameProperty = ref('');
const priceValueProperty = ref(10000);
const dateStartUsingProperty = ref(new Date().toISOString().substr(0, 10));
const yearUsedProperty = ref(10);
const yearFollow = ref(new Date().getFullYear());
...
function showWarning(type) {
    console.log('dang goi den m nay');
    ...
    <div id="myPopup" class="popup" :class="{ show: isShowPopup }">
        <div class="popup-content">
            <div class="popup__div--form-header">
                <h2 class="inline--block">Sửa tài sản</h2>
